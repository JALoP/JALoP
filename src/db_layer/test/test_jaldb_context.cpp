...
extern "C" void test_purge_audit_works()
{
	enum jaldb_status ret;
	int db_err;
	...
	string sid = "abc";
	string src = "1.2.3.4";
	ret = jaldb_insert_audit_record_into_temp(context, src,
		audit_sys_meta_doc, audit_app_meta_doc, audit_doc, sid);
	assert_equals(JALDB_OK, ret);
	...
	ret = jaldb_store_confed_audit_sid_tmp(context, src.c_str(), sid.c_str(), &db_err);
	assert_equals(JALDB_OK, ret);
...
extern "C" void test_purge_audit_works_with_no_confed_records()
{
	enum jaldb_status ret;
	...
	string sys_db = jaldb_make_temp_db_name(src, JALDB_AUDIT_SYS_META_CONT_NAME);
	string app_db = jaldb_make_temp_db_name(src, JALDB_AUDIT_APP_META_CONT_NAME);
	string audit_db = jaldb_make_temp_db_name(src, JALDB_AUDIT_CONT_NAME);
	XmlContainer sys_cont;
	XmlContainer app_cont;
	XmlContainer audit_cont;
...
extern "C" void test_purge_audit_works_with_when_empty()
{
	enum jaldb_status ret;
...
extern "C" void test_purge_audit_returns_error_on_bad_input()
{
	string src = "1.2.3.4";
	enum jaldb_status ret;
...
extern "C" void test_purge_log_with_no_confed_records()
{
	enum jaldb_status ret;
	int db_err;
...
extern "C" void test_purge_log_works_with_no_records()
{
	enum jaldb_status ret;
	int db_err;
...
extern "C" void test_purge_log_works()
{
	enum jaldb_status ret;
	int db_err;
...
extern "C" void test_purge_log_returns_error_on_bad_input()
{
	string src = "1.2.3.4";
	enum jaldb_status ret;
	int db_ret;
...
extern "C" void test_purge_journal_works()
{
	enum jaldb_status ret;
	int db_err;
...
extern "C" void test_purge_journal_works_with_no_confed_records()
{
	enum jaldb_status ret;
...
extern "C" void test_purge_journal_works_with_when_empty()
{
	enum jaldb_status ret;
...
extern "C" void test_purge_journal_returns_error_on_bad_input()
{
	string src = "1.2.3.4";
	enum jaldb_status ret;
...
extern "C" void test_jaldb_get_last_k_records_works()
{
	...
	enum jaldb_status ret =
		jaldb_get_last_k_records(context->log_sys_cont,
					context->manager, LAST_K_RECORDS_VALUE,
					res);
	assert_equals(JALDB_OK, ret);
	if (0 == res.size()) {
		assert_true(false);
	...
	try {
		int i = LIMIT - LAST_K_RECORDS_VALUE;

...
#
#To run collect_system_calls.py
#./collect_system_calls.py strace.out > my_rules.txt
#
#To add a seccomp mark to your program where it transitions from setup stage to routine work stage
...
#	// }
#
#my_rules.txt will display:
#initial_seccomp_rules[] allowable calls only needed in setup stage.
#both_seccomp_rules[] allowable rules needed in both stages.
#final_seccomp_rules[] allowable rules only needed in routine work stage.

...
##strace -f -o jalls_strace.out ./release/bin/jal-local-store -d --no-daemon -c ./test-input/local_store.cfg
##strace -f -o jald_strace.out ./release/bin/jald -c ./test-input/jald.cfg -d --no-daemon -s
##strace -f -o jalsub_strace.out ./release/bin/jal_subscribe -c test-input/jal_subscribe.cfg -s -d

...
#define NONCE1 "9a5754ef-ce82-4dd2-af61-d329cc526203_2025-02-06T09:12:34.12345_1234_12345"
#define NONCE2 "9c5754ef-ce82-4dd2-af61-d329cc526203_2025-02-06T09:12:34.12345_1234_12345"
...
extern "C" void test_jaldb_purge_unconfirmed_records()
{
	...
	rec1->network_nonce = jal_strdup(NONCE1);
	...
	rec2->network_nonce = jal_strdup(NONCE2);
	...
	assert_equals(JALDB_OK, jaldb_get_record(context, JALDB_RTYPE_LOG, nonce3, &rec_final));

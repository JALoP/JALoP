...
extern "C" void test_jaldb_create_record_works()
{
	uuid_t test_uuid;
...
extern "C" void test_jaldb_destroy_record_works_does_not_crash()
{
...
extern "C" void test_jaldb_destroy_release_all_elements()
{
	struct jaldb_record *record = jaldb_create_record();
...
extern "C" void test_jaldb_destroy_works()
{
	struct jaldb_record *record = jaldb_create_record();
	jaldb_destroy_record(&record);
	assert_pointer_equals((void*) NULL, record);
...
extern "C" void test_jaldfb_record_sanity_check_works_for_journal()
{
	...
	ret = jaldb_record_sanity_check(record, -1);
...
extern "C" void test_jaldfb_record_sanity_check_works_for_audit()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
...
extern "C" void test_jaldb_record_sanity_check_works_for_log()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
...
extern "C" void test_jaldb_record_sanity_check_fails_for_null()
{
	enum jaldb_status ret;

	ret = jaldb_record_sanity_check(NULL, -1);
	assert_not_equals(JALDB_OK, ret);
}

extern "C" void test_jaldfb_record_sanity_check_fails_on_bad_segments()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
...
extern "C" void test_jaldb_record_sanity_check_fails_on_missing_fields()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
...
extern "C" void test_jaldb_record_sanity_check_fails_for_large_log_record()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
	long long max_record_size = 20000000;
	...
	ret = jaldb_record_sanity_check(record, max_record_size);
...
extern "C" void test_jaldb_record_sanity_check_fails_for_large_journal_record()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
	long long max_record_size = 20000000;
...
extern "C" void test_jaldb_record_sanity_check_fails_for_large_audit_record()
{
	enum jaldb_status ret;
	struct jaldb_record *record = jaldb_create_record();
	long long max_record_size = 20000000;

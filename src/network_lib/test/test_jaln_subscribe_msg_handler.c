...
{
	assert_equals(JAL_OK, jaln_process_subscribe((VortexFrame*) 0xbadf00d));
}
...
void test_process_subscribe_fails_when_ct_and_xfr_check_fails()
{
	...
	assert_equals(JAL_E_INVAL, jaln_process_subscribe((VortexFrame*) 0xbadf00d));
}
...
{
	assert_not_equals(JAL_OK, jaln_process_subscribe(NULL));

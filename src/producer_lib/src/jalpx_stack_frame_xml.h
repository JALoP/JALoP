/**
 * @file jalpx_stack_frame_xml.h This file defines functions to deal with
 ...
 */
#ifndef _JALPX_STACK_FRAME_XML_H_
#define _JALPX_STACK_FRAME_XML_H_
 ...
 */
enum jal_status jalpx_stack_frame_to_elem(
		const struct jalp_stack_frame *stack_frame,
		xmlDocPtr doc,
		xmlNodePtr *new_elem);

#endif //_JALPX_STACK_FRAME_XML_H_

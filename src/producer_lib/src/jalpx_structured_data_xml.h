/**
 * @file jalpx_structured_data_xml.h This file defines functions to handle
 ...
 */
#ifndef _JALPX_STRUCTURED_DATA_XML_H_
#define _JALPX_STRUCTURED_DATA_XML_H_
 ...
 */
enum jal_status jalpx_structured_data_to_elem(const struct jalp_structured_data *sd,
						xmlDocPtr doc,
						xmlNodePtr *new_elem);

#endif //_JALPX_STRUCTURED_DATA_XML_H_

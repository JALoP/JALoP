/**
 * @file jalpx_syslog_metadata_xml.h This file defines functions to deal with
 ...
 */
#ifndef _JALPX_SYSLOG_METADATA_XML_H_
#define _JALPX_SYSLOG_METADATA_XML_H_
...
/**
 * Convert a jalp_syslog_metadata struct to a DOMDocument element
...
#endif //_JALPX_LOG_SEVERITY_XML_H_

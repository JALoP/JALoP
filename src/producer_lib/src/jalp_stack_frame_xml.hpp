/**
 * @file jalp_stack_frame_xml.hpp This file defines functions to deal with
 ...
 */
#ifndef _JALP_STACK_FRAME_XML_HPP_
#define _JALP_STACK_FRAME_XML_HPP_
...
#endif //_JALP_STACK_FRAME_XML_HPP_

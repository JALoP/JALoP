/**
 * @file jalpx_log_severity_xml.h This file defines functions to deal with
 ...
 */
#ifndef _JALPX_LOG_SEVERITY_XML_H_
#define _JALPX_LOG_SEVERITY_XML_H_
 ...
 */
enum jal_status jalpx_log_severity_to_elem(

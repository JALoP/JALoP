/**
 * @file jalpx_logger_metadata_xml.h This file defines functions to handle
 ...
 */
#ifndef _JALPX_LOGGER_METADATA_XML_H_
#define _JALPX_LOGGER_METADATA_XML_H_
 ...
 */
enum jal_status jalpx_logger_metadata_to_elem(
...
#endif //_JALPX_LOGGER_METADATA_XML_H_

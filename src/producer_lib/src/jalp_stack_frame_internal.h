 ...
 */
#ifndef _JALP_STACK_FRAME_INTERNAL_H_
#define _JALP_STACK_FRAME_INTERNAL_H_
...
/**
 * Release all memory associated with one stack frame. This will release all
 * associated memory using the appropriate "*_destroy()" function or "free()".
 *
 * @param[in,out] stack_frame The stack frame to release.
 */
...
#endif //_JALP_STACK_FRAME_INTERNAL_H_

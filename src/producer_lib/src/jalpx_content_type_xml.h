 /**
 * @file jalpx_content_type_xml.h This file defines functions to deal with
...
#ifndef _JALPX_CONTENT_TYPE_XML_H_
#define _JALPX_CONTENT_TYPE_XML_H_
 ...
 */
enum jal_status jalpx_content_type_to_elem(
		const struct jalp_content_type * content_type,
		xmlDocPtr doc,
		xmlNodePtr *elem);

#endif //_JALPX_CONTENT_TYPE_XML_H_

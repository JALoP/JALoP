...
void test_param_to_elem_returns_null_with_null_inputs()
{
	...
	ret = jalp_param_to_elem(param2, (xmlChar *)P1_TAG, (xmlChar *)P1_ATTR, app_meta_elem, NULL);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	...
	ret = jalp_param_to_elem(param2, (xmlChar *)P1_TAG, NULL, app_meta_elem, &new_elem);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	assert_equals((void*)NULL, new_elem);

	ret = jalp_param_to_elem(param2, NULL, (xmlChar *)P1_ATTR, app_meta_elem, &new_elem);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	assert_equals((void*)NULL, new_elem);

	ret = jalp_param_to_elem(NULL, (xmlChar *)P1_TAG, (xmlChar *)P1_ATTR, app_meta_elem, &new_elem);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	assert_equals((void*)NULL, new_elem);
}
...
{
	xmlNodePtr new_elem = NULL;
	enum jal_status ret = jalp_param_to_elem(param1, (xmlChar *)P1_TAG, (xmlChar *)P1_ATTR, app_meta_elem, &new_elem);
	assert_equals(JAL_OK, ret);
	assert_not_equals(NULL, new_elem);

	xmlNodePtr orig = new_elem;
	ret = jalp_param_to_elem(param1, (xmlChar *)P1_TAG, (xmlChar *)P1_ATTR, app_meta_elem, &new_elem);
	assert_equals(JAL_E_XML_CONVERSION, ret);
...
void test_param_to_elem_works_with_normal_param_different_values()
{
	// <Field Key="key1"/>val1</Field>
	xmlNodePtr new_elem = NULL;
	enum jal_status ret = jalp_param_to_elem(param2, (xmlChar *)P2_TAG, (xmlChar *)P2_ATTR, app_meta_elem, &new_elem);
	assert_equals(JAL_OK, ret);
	assert_not_equals(NULL, new_elem);

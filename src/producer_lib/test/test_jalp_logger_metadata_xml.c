...
void test_logger_metadata_to_elem_returns_null_for_null()
{
	assert_equals(JAL_E_XML_CONVERSION,
			jalp_logger_metadata_to_elem(NULL, ctx, app_meta_elem, &new_elem));
	assert_equals((void*)NULL, new_elem);

	assert_equals(JAL_E_XML_CONVERSION,
			jalp_logger_metadata_to_elem(logger_metadata, NULL, app_meta_elem, &new_elem));
	assert_equals((void*)NULL, new_elem);
	...
	assert_equals(JAL_E_XML_CONVERSION,
			jalp_logger_metadata_to_elem(logger_metadata, ctx, app_meta_elem, NULL));
}
...
void test_logger_metadata_to_elem_returns_invalid_new_elem_non_null()
{
	...
	assert_equals(JAL_E_XML_CONVERSION,
			jalp_logger_metadata_to_elem(logger_metadata, ctx, app_meta_elem, &new_elem));

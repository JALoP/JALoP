...
void test_jalp_journal_metadata_to_elem_returns_error_for_bad_input()
{
	...
	enum jal_status ret;
	ret = jalp_journal_metadata_to_elem(NULL, app_meta_elem, &new_elem);
	...
	assert_equals(JAL_E_XML_CONVERSION, ret);
	ret = jalp_journal_metadata_to_elem(jmeta, app_meta_elem, NULL);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	ret = jalp_journal_metadata_to_elem(NULL, app_meta_elem, NULL);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	ret = jalp_journal_metadata_to_elem(jmeta, NULL, NULL);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	ret = jalp_journal_metadata_to_elem(NULL, NULL, NULL);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	ret = jalp_journal_metadata_to_elem(jmeta, app_meta_elem, &bad_elem);
	assert_equals(JAL_E_XML_CONVERSION, ret);
	ret = jalp_journal_metadata_to_elem(NULL, app_meta_elem, &bad_elem);
	assert_equals(JAL_E_XML_CONVERSION, ret);
...
void test_jalp_journal_metadata_to_elem_returns_error_when_missing_a_file_info_struct()
{
	...
	ret = jalp_journal_metadata_to_elem(jmeta, app_meta_elem, &new_elem);

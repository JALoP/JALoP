...
/** jald-specific implementation for the callback "connect_request_handler" offered by
 * the jaln_network library. Handles an incoming connection request from the
 * subscriber.
 *
 * @param[in] req Information about the request
 * @param[in] selected_encoding Unused
 * @param[in] selected_digest Unused
 ...
 * the jaln_network library. Currently performs no action.
 *
 * @param[in] jal_conn Unused
 * @param[in] user_data Unused
 */
...
/** jald-specific implementation for the callback "connect_ack" offered by
 * the jaln_network library. Currently performs no action.
 *
 * @param[in] ack Unused
 * @param[in] user_data Unused
...
/** jald-specific implementation for the callback "connect_nack" offered by
 * the jaln_network library. Currently performs no action.
 *
 ...
 * the jaln_network library. Creates a new session for this subscription and inserts
 * it to our session lists. Creates and runs the thread to handle lookup and sending
 * of the requested record type
 *
 * @param[in] sess  The jaln_session created to handle this subscription by the
 * network library
 * @param ch_info_param Information about the channel created to handle this record type

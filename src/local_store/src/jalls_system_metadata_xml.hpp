...
#ifndef _JALLS_SYSTEM_METADATA_XML_HPP_
#define _JALLS_SYSTEM_METADATA_XML_HPP_
 ...
 */
int jalls_create_system_metadata(enum jalls_data_type data_type, const char *hostname, const char *host_uuid,
...
#endif //_JALLS_SYSTEM_METADATA_XML_HPP_

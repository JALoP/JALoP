...
static struct argp_option options[] =
{
	...
	{"data", 'd', "D", 0, "Specifies which section of the data should be dumped, options are 'a' for application metadata, 's' for system metadata, or 'p' for the payload (raw journal, audit, or log data). The default is to dump the system metadata. If this option is specified multiple times, the last occurrence is used. To retrieve all portions of a record, use 'z'.", 0},
